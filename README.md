...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-esqh7e.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-esqh7e.containers.anotherwebservice.com/
...
```
git clone git@github.com:anshjeengar/container-esqh7e.git
cd container-esqh7e
```
...
```
docker attach container-esqh7e
```
